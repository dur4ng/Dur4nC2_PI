...
func (x *Whoami) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_commonpb_common_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x43, 0x6d, 0x64, 0x4c, 0x69, 0x6e, 0x65, 0x22, 0x24, 0x0a, 0x06, 0x57,
	0x68, 0x6f, 0x61, 0x6d, 0x69, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x22, 0x30, 0x0a, 0x06, 0x45, 0x6e, 0x76, 0x56, 0x61, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x4b,
	...
	0x6c, 0x75, 0x65, 0x42, 0x1b, 0x5a, 0x19, 0x44, 0x75, 0x72, 0x34, 0x6e, 0x43, 0x32, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x70, 0x62,
...
var file_commonpb_common_proto_goTypes = []interface{}{
	...
	(*Whoami)(nil),   // 5: commonpb.Whoami
	(*EnvVar)(nil),   // 6: commonpb.EnvVar
}
...
func file_commonpb_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_commonpb_common_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EnvVar); i {
			case 0:
				return &v.state
			case 1:
